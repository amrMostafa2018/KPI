using DFI.Application.Features.Positions.Queries.GetPositions;
using DFI.Application.Interfaces;
using DFI.Application.Interfaces.Repositories;
using DFI.Application.Parameters;
using DFI.Domain.Entities;
using DFI.Infrastructure.Persistence.Contexts;
using DFI.Infrastructure.Persistence.Repository;
using LinqKit;
